...
function genCSSMotion(config) {
  ...
  var CSSMotion = /*#__PURE__*/function (_React$Component) {
    ...
    var _super = _createSuper$1(CSSMotion);
    ...
    function CSSMotion() {
      ...
      _this.updateStatus = function (styleFunc, additionalState, event, callback) {
        ...
        _this.setState(_objectSpread2$1({
          statusStyle: _typeof$1(statusStyle) === 'object' ? statusStyle : null,
          newStatus: false
...
var Popup = /*#__PURE__*/function (_Component) {
  ...
  var _super = _createSuper$2(Popup);
  ...
  _createClass$2(Popup, [{
    ...
    value: function getDerivedStateFromProps(_ref3, _ref4) {
      var visible = _ref3.visible,
          props = _objectWithoutProperties$2(_ref3, ["visible"]);
...
var Tooltip = function Tooltip(props, ref) {
  ...
  } else if (destroyTooltipOnHide && _typeof$6(destroyTooltipOnHide) === 'object') {
...
function Dropdown(props, ref) {
  var _props$arrow = props.arrow,
      ...
      _props$trigger = props.trigger,
      trigger = _props$trigger === void 0 ? ['hover'] : _props$trigger,
      otherProps = _objectWithoutProperties$4(props, ["arrow", "prefixCls", "transitionName", "animation", "align", "placement", "placements", "getPopupContainer", "showAction", "hideAction", "overlayClassName", "overlayStyle", "visible", "trigger"]);
  ...
  return react.createElement(Trigger, Object.assign({}, otherProps, {
    prefixCls: prefixCls,
    ref: triggerRef,
    popupClassName: classnames(overlayClassName, _defineProperty$6({}, "".concat(prefixCls, "-show-arrow"), arrow)),
    popupStyle: overlayStyle,
    builtinPlacements: placements,
    action: trigger,
...
var BreadcrumbItem = function BreadcrumbItem(_a) {
  var customizePrefixCls = _a.prefixCls,
      ...
      restProps = __rest$4(_a, ["prefixCls", "separator", "children", "overlay", "dropdownProps"]);
  ...
  var renderBreadcrumbNode = function renderBreadcrumbNode(breadcrumbItem) {
    if (overlay) {
      return /*#__PURE__*/react.createElement(Dropdown$2, _extends_1({
        overlay: overlay,
  ...
  if ('href' in restProps) {
    link = /*#__PURE__*/react.createElement("a", _extends_1({
      className: "".concat(prefixCls, "-link")
    }, restProps), children);
  } else {
    link = /*#__PURE__*/react.createElement("span", _extends_1({
      className: "".concat(prefixCls, "-link")
    }, restProps), children);
  } // wrap to dropDown
...
function isMobile(userAgent) {
  ...
  if (typeof tmp[1] !== 'undefined') {
    ...
    var _tmp2 = _slicedToArray$4(_tmp, 1);
  ...
  if (typeof tmp[1] !== 'undefined') {
    ...
    var _tmp4 = _slicedToArray$4(_tmp3, 1);
...
var setStyle = function setStyle(elem, styleProperty, value) {
  if (elem && _typeof$7(elem.style) === 'object') {
...
var updateDefaultActiveFirst = function updateDefaultActiveFirst(store, eventKey, defaultActiveFirst) {
  ...
  store.setState({
    defaultActiveFirst: _objectSpread2$4(_objectSpread2$4({}, state.defaultActiveFirst), {}, _defineProperty$7({}, menuId, defaultActiveFirst))
  });
};

var SubMenu = /*#__PURE__*/function (_React$Component) {
  _inherits$4(SubMenu, _React$Component);

  var _super = _createSuper$4(SubMenu);

  function SubMenu(props) {
    var _this;

    _classCallCheck$4(this, SubMenu);
    ...
    _this.onMouseLeave = function (e) {
      var _this$props3 = _this.props,
          ...
          onMouseLeave = _this$props3.onMouseLeave;
      parentMenu.subMenuInstance = _assertThisInitialized$4(_this);
      onMouseLeave({
        key: eventKey,
        domEvent: e
      });
    ...
    _this.getBaseProps = function () {
      var _assertThisInitialize2 = _assertThisInitialized$4(_this),
      ...
      return {
        ...
        parentMenu: _assertThisInitialized$4(_this),
    ...
    _this.getMotion = function (mode, visible) {
      var _assertThisInitialize3 = _assertThisInitialized$4(_this),
  ...
  _createClass$4(SubMenu, [{
    ...
    value: function renderChildren(children) {
      ...
      return react.createElement(CSSMotion, Object.assign({
        ...
        var className = _ref.className,
            style = _ref.style;
        var mergedClassName = classnames("".concat(baseProps.prefixCls, "-sub"), className, _defineProperty$7({}, "".concat(baseProps.prefixCls, "-rtl"), direction === 'rtl'));
    ...
    value: function render() {
      ...
      var className = classnames(prefixCls, "".concat(prefixCls, "-").concat(props.mode), (_classNames2 = {}, _defineProperty$7(_classNames2, props.className, !!props.className), _defineProperty$7(_classNames2, this.getOpenClassName(), isOpen), _defineProperty$7(_classNames2, this.getActiveClassName(), props.active || isOpen && !isInlineMode), _defineProperty$7(_classNames2, this.getDisabledClassName(), props.disabled), _defineProperty$7(_classNames2, this.getSelectedClassName(), this.isChildrenSelected()), _classNames2));
...
var DOMWrap = /*#__PURE__*/function (_React$Component) {
  _inherits$4(DOMWrap, _React$Component);

  var _super = _createSuper$4(DOMWrap);

  function DOMWrap() {
    var _this;

    _classCallCheck$4(this, DOMWrap);
    ...
    _this.getMenuItemNodes = function () {
      ...
      var ul = reactDom.findDOMNode(_assertThisInitialized$4(_this));
    ...
    _this.getOverflowedSubMenuItem = function (keyPrefix, overflowedItems, renderPlaceholder) {
      ...
      var _copy$props = copy.props,
          ...
          rest = _objectWithoutProperties$5(_copy$props, ["children", "title", "style"]);
  ...
  _createClass$4(DOMWrap, [{
    ...
    value: function render() {
      var _this$props2 = this.props,
          ...
          rest = _objectWithoutProperties$5(_this$props2, ["visible", "prefixCls", "overflowedIndicator", "mode", "level", "tag", "children", "theme"]);
...
function updateActiveKey(store, menuId, activeKey) {
  var state = store.getState();
  store.setState({
    activeKey: _objectSpread2$4(_objectSpread2$4({}, state.activeKey), {}, _defineProperty$7({}, menuId, activeKey))
  });
}
...
var SubPopupMenu = /*#__PURE__*/function (_React$Component) {
  _inherits$4(SubPopupMenu, _React$Component);

  var _super = _createSuper$4(SubPopupMenu);

  function SubPopupMenu(props) {
    var _this;

    _classCallCheck$4(this, SubPopupMenu);
    ...
    _this.renderCommonMenuItem = function (child, i, extraProps) {
      ...
      var newChildProps = _objectSpread2$4(_objectSpread2$4({
        ...
        manualRef: childProps.disabled ? undefined : createChainedFunction(child.ref, saveRef.bind(_assertThisInitialized$4(_this))),
        eventKey: key,
    ...
    props.store.setState({
      activeKey: _objectSpread2$4(_objectSpread2$4({}, props.store.getState().activeKey), {}, _defineProperty$7({}, props.eventKey, getActiveKey(props, props.activeKey)))
    });
    _this.instanceArray = [];
    return _this;
  }

  _createClass$4(SubPopupMenu, [{
    key: "componentDidMount",
    value: function componentDidMount() {
...
function getMotion$1(_ref, _ref2, menuMode) {
  ...
  if (_typeof$7(openAnimation) === 'object' && openAnimation) {
...
var Menu = /*#__PURE__*/function (_React$Component) {
  _inherits$4(Menu, _React$Component);
  ...
  function Menu(props) {
    ...
    _this.onDeselect = function (selectInfo) {
      var _assertThisInitialize4 = _assertThisInitialized$4(_this),
...
var MenuItem = /*#__PURE__*/function (_React$Component) {
  _inherits$4(MenuItem, _React$Component);

  var _super = _createSuper$4(MenuItem);

  function MenuItem() {
    var _this;

    _classCallCheck$4(this, MenuItem);
  ...
  _createClass$4(MenuItem, [{
    ...
    value: function render() {
      ...
      var className = classnames(this.getPrefixCls(), props.className, (_classNames = {}, _defineProperty$7(_classNames, this.getActiveClassName(), !props.disabled && props.active), _defineProperty$7(_classNames, this.getSelectedClassName(), props.isSelected), _defineProperty$7(_classNames, this.getDisabledClassName(), props.disabled), _classNames));
...
var MenuItemGroup = /*#__PURE__*/function (_React$Component) {
  _inherits$4(MenuItemGroup, _React$Component);

  var _super = _createSuper$4(MenuItemGroup);

  function MenuItemGroup() {
    var _this;

    _classCallCheck$4(this, MenuItemGroup);
...
var BarsOutlined_1$1 = createCommonjsModule(function (module, exports) {
...
var _BarsOutlined = interopRequireDefault(BarsOutlined_1);
...
var BarsOutlined = createCommonjsModule(function (module, exports) {
  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.default = void 0;
  
  var _BarsOutlined = _interopRequireDefault(BarsOutlined_1$1);
...
function generator(_ref) {
  ...
  return function (BasicComponent) {
    ...
    return _a = /*#__PURE__*/function (_React$Component) {
      ...
      var _super = createSuper(Adapter);
      ...
      function Adapter() {
        ...
        _this.renderComponent = function (_ref2) {
          ...
          return /*#__PURE__*/react.createElement(BasicComponent, _extends_1({
            prefixCls: prefixCls,
            tagName: tagName
          }, _this.props));
        };
...
var Basic = function Basic(props) {
  var prefixCls = props.prefixCls,
      ...
      others = __rest$5(props, ["prefixCls", "className", "children", "tagName"]);

  var classString = classnames(prefixCls, className);
  return /*#__PURE__*/react.createElement(tagName, _extends_1({
    className: classString
  }, others), children);
};

var BasicLayout = /*#__PURE__*/function (_React$Component2) {
  inherits(BasicLayout, _React$Component2);

  var _super2 = createSuper(BasicLayout);

  function BasicLayout() {
    var _this2;

    classCallCheck(this, BasicLayout);
    ...
    _this2.renderComponent = function (_ref3) {
      ...
      var _a = _this2.props,
          ...
          Tag = _a.tagName,
          others = __rest$5(_a, ["prefixCls", "className", "children", "hasSider", "tagName"]);

      var classString = classnames(prefixCls, (_classNames = {}, defineProperty(_classNames, "".concat(prefixCls, "-has-sider"), typeof hasSider === 'boolean' ? hasSider : _this2.state.siders.length > 0), defineProperty(_classNames, "".concat(prefixCls, "-rtl"), direction === 'rtl'), _classNames), className);
      return /*#__PURE__*/react.createElement(LayoutContext.Provider, {
        value: {
          siderHook: _this2.getSiderHook()
        }
      }, /*#__PURE__*/react.createElement(Tag, _extends_1({
        className: classString
      }, others), children));
    };
      ...
      return {
        addSider: function addSider(id) {
          _this3.setState(function (state) {
            return {
              siders: [].concat(toConsumableArray(state.siders), [id])
            };
          });
        },
...
var InternalSider = /*#__PURE__*/function (_React$Component) {
  inherits(InternalSider, _React$Component);

  var _super = createSuper(InternalSider);

  function InternalSider(props) {
    var _this;

    classCallCheck(this, InternalSider);
    ...
    _this.renderSider = function (_ref) {
      ...
      var _a = _this.props,
          ...
          children = _a.children,
          others = __rest$6(_a, ["prefixCls", "className", "theme", "collapsible", "reverseArrow", "trigger", "style", "width", "collapsedWidth", "zeroWidthTriggerStyle", "children"]);
      ...
      var divStyle = _extends_1(_extends_1({}, style), {
      ...
      var siderCls = classnames(className, prefixCls, "".concat(prefixCls, "-").concat(theme), (_classNames = {}, defineProperty(_classNames, "".concat(prefixCls, "-collapsed"), !!collapsed), defineProperty(_classNames, "".concat(prefixCls, "-has-trigger"), collapsible && trigger !== null && !zeroWidthTrigger), defineProperty(_classNames, "".concat(prefixCls, "-below"), !!below), defineProperty(_classNames, "".concat(prefixCls, "-zero-width"), parseFloat(siderWidth) === 0), _classNames));
      return /*#__PURE__*/react.createElement("aside", _extends_1({
        className: siderCls
      }, divProps, {
        style: divStyle
...
var Sider = /*#__PURE__*/function (_React$Component2) {
  inherits(Sider, _React$Component2);

  var _super2 = createSuper(Sider);

  function Sider() {
    classCallCheck(this, Sider);
  ...
  createClass(Sider, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/react.createElement(LayoutContext.Consumer, null, function (context) {
        return /*#__PURE__*/react.createElement(InternalSider, _extends_1({}, context, _this2.props));
      });
    }
  }]);
  ...
  function MenuItem() {
    ...
    _this.renderItem = function (_ref) {
      ...
      var _a = _this.props,
          ...
          icon = _a.icon,
          danger = _a.danger,
          rest = __rest$7(_a, ["title", "icon", "danger"]);
...
var addChildPath = function addChildPath(paths) {
  ...
  var originalPaths = toConsumableArray(paths);
...
var Breadcrumb = function Breadcrumb(_a) {
  var customizePrefixCls = _a.prefixCls,
      ...
      restProps = __rest$8(_a, ["prefixCls", "separator", "style", "className", "routes", "children", "itemRender", "params"]);
  ...
  if (routes && routes.length > 0) {
    ...
    crumbs = routes.map(function (route) {
      ...
      if (route.children && route.children.length) {
        overlay = /*#__PURE__*/react.createElement(Menu$1, null, route.children.map(function (child) {
  ...
  var breadcrumbClassName = classnames(className, prefixCls, defineProperty({}, "".concat(prefixCls, "-rtl"), direction === 'rtl'));
  return /*#__PURE__*/react.createElement("div", _extends_1({
...
export { Breadcrumb, Layout, Menu$1 as Menu };
